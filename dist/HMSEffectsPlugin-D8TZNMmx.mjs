(() => {
	let e = globalThis.React, t = globalThis.ReactDOM;
	globalThis.require || (globalThis.require = (n) => {
		if (n === "react") return e;
		if (n === "react-dom") return t;
		throw Error("Cannot require " + n);
	});
})();
import { t as e } from "./tsvb-CDO5phxV.mjs";
