...
/** @public */
export declare type BoxLike = Box2d | Box2dModel;
...
/** @public */
export declare function Canvas({ className }: {
    className?: string;
}): JSX.Element;
...
export declare class Editor extends EventEmitter<TLEventMap> {
    ...
    /* Excluded from this release type: _getShapeOutlineSegmentsCache */
    /**
...
/** @public */
export declare type TLInFrontOfTheCanvas = ComponentType<object>;
...
/** @public */
declare type TLLoadingScreenComponent = ComponentType<object>;
...
/** @public */
export declare type TLOnTheCanvas = ComponentType<object>;
