...
class SnapManager {
  ...
  get lines() {
    (0, import_utils.warnDeprecatedGetter)("lines");
  ...
  // eslint-disable-next-line no-restricted-syntax
  get snapPointsCache() {
    (0, import_utils.warnDeprecatedGetter)("snapPointsCache");
  ...
  // eslint-disable-next-line no-restricted-syntax
  get snapThreshold() {
    (0, import_utils.warnDeprecatedGetter)("snapThreshold");
  ...
  // eslint-disable-next-line no-restricted-syntax
  get snappableShapes() {
    (0, import_utils.warnDeprecatedGetter)("snappableShapes");
  ...
  get currentCommonAncestor() {
    (0, import_utils.warnDeprecatedGetter)("currentCommonAncestor");
  ...
  // eslint-disable-next-line no-restricted-syntax
  get snappablePoints() {
    (0, import_utils.warnDeprecatedGetter)("snappablePoints");
  ...
  // eslint-disable-next-line no-restricted-syntax
  get visibleGaps() {
    (0, import_utils.warnDeprecatedGetter)("visibleGaps");
  ...
  get outlinesInPageSpace() {
    (0, import_utils.warnDeprecatedGetter)("outlinesInPageSpace");
