...
const TldrawEditorWithLoadingStore = (0, import_react.memo)(function TldrawEditorBeforeLoading({
  ...
  switch (store.status) {
    ...
    case "loading": {
      const LoadingScreen2 = rest.components?.LoadingScreen ?? import_DefaultLoadingScreen.DefaultLoadingScreen;
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoadingScreen2, {});
    }
    case "not-synced": {
      break;
    }
