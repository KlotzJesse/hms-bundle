...
const MoveToPageMenu = track(function MoveToPageMenu2() {
  ...
  return /* @__PURE__ */ jsxs(_ContextMenu.Sub, { children: [
    ...
    /* @__PURE__ */ jsx(_ContextMenu.Portal, { container, children: /* @__PURE__ */ jsxs(_ContextMenu.SubContent, { className: "tlui-menu", sideOffset: -4, collisionPadding: 4, children: [
      /* @__PURE__ */ jsx(
        _ContextMenu.Group,
        {
          dir: "ltr",
            ...
            _ContextMenu.Item,
            {
              ...
              children: /* @__PURE__ */ jsx(
                Button,
                {
                  ...
                  children: /* @__PURE__ */ jsx("span", { className: "tlui-button__label", children: page.name })
                }
              )
            },
            page.id
            ...
            _ContextMenu.Item,
            {
              ...
              children: /* @__PURE__ */ jsx(
                Button,
                {
                  ...
                  className: "tlui-context-menu__move-to-page__name",
                  children: /* @__PURE__ */ jsx("span", { className: "tlui-button__label", children: msg("context.pages.new-page") })
                }
              )
            },
            "new-page"
