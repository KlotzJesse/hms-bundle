...
function TLUiMenuSchemaProvider({ overrides, children }) {
  ...
  const selectedCount = (0, import_editor.useValue)("selectedCount", () => editor.getSelectedShapeIds().length, [
    editor
  ]);
  ...
  const isZoomedTo100 = (0, import_editor.useValue)("isZoomedTo100", () => editor.getZoomLevel() === 1, [editor]);
