...
const TLUiContextMenuSchemaProvider = (0, import_editor.track)(function TLUiContextMenuSchemaProvider2({
  ...
  const allowRemoveFrame = oneSelected && selectedShapes.every((shape) => editor.isShapeOfType(shape, "frame"));
  const allowFitFrameToContent = onlySelectedShape && editor.isShapeOfType(onlySelectedShape, "frame") && editor.getSortedChildIdsForParent(onlySelectedShape).length > 0;
  ...
  const contextTLUiMenuSchema = (0, import_react.useMemo)(() => {
    let contextTLUiMenuSchema2 = (0, import_menuHelpers.compactMenuItems)([
      (0, import_menuHelpers.menuGroup)(
        ...
        allowRemoveFrame && !isShapeLocked && (0, import_menuHelpers.menuItem)(actions["remove-frame"]),
        allowFitFrameToContent && !isShapeLocked && (0, import_menuHelpers.menuItem)(actions["fit-frame-to-content"]),
