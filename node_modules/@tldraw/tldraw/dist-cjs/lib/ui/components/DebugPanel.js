...
const DebugPanel = React.memo(function DebugPanel2({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "tlui-debug-panel", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenu.Root, { id: "debug", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DropdownMenu.Trigger, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_Button.Button, { type: "icon", icon: "dots-horizontal", title: msg("debug-panel.more") }) }),
...
const CurrentState = (0, import_editor.track)(function CurrentState2() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "tlui-debug-panel__current-state", children: editor.getPath() });
});
const ShapeCount = function ShapeCount2() {
  const editor = (0, import_editor.useEditor)();
  const count = (0, import_editor.useValue)("rendering shapes count", () => editor.getRenderingShapes().length, [
    editor
  ]);
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenu.Group, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        DropdownMenu.Item,
        {
          ...
          label: (0, import_useTranslation.untranslated)("Show dialog")
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        DropdownMenu.Item,
        {
          ...
          label: (0, import_useTranslation.untranslated)("Create 100 shapes")
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        DropdownMenu.Item,
        {
          ...
          label: (0, import_useTranslation.untranslated)("Count shapes / nodes")
        }
      ),
      (() => {
        if (error)
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        DropdownMenu.Item,
        {
          ...
          label: (0, import_useTranslation.untranslated)("Throw error")
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        DropdownMenu.Item,
        {
          ...
          label: (0, import_useTranslation.untranslated)("Hard reset")
        }
      )
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenu.Group, { children: [
...
function Toggle({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ...
    {
      title: (0, import_useTranslation.untranslated)(label),
      checked: value,
      onSelect: () => onChange(!value),
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "tlui-button__label", draggable: false, children: label })
    }
  );
}
...
function ExampleDialog({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Dialog.Footer, { className: "tlui-dialog__footer__actions", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_Button.Button, { type: "normal", onClick: onCancel, children: cancel }),
