...
function Tldraw(props) {
  ...
  const components = (0, import_editor.useShallowObjectIdentity)(rest.components ?? {});
  const shapeUtils = (0, import_editor.useShallowArrayIdentity)(rest.shapeUtils ?? []);
  const tools = (0, import_editor.useShallowArrayIdentity)(rest.tools ?? []);
  const withDefaults = {
    initialState: "select",
    ...rest,
    ...
    shapeUtils: (0, import_react.useMemo)(() => [...import_defaultShapeUtils.defaultShapeUtils, ...shapeUtils], [shapeUtils]),
    tools: (0, import_react.useMemo)(() => [...import_defaultTools.defaultTools, ...import_defaultShapeTools.defaultShapeTools, ...tools], [tools])
  };
