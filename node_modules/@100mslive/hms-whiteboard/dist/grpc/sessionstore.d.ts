...
declare class CountRequest$Type extends MessageType<CountRequest> {
    constructor();
 ...
 */
export declare const CountRequest: CountRequest$Type;
declare class CountResponse$Type extends MessageType<CountResponse> {
    constructor();
 ...
 */
export declare const CountResponse: CountResponse$Type;
/**
