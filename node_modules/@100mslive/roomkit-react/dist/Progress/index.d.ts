...
export declare const Progress: {
    Root: import("@stitches/react/types/styled-component").StyledComponent<import("react").ForwardRefExoticComponent<import("@radix-ui/react-progress").ProgressProps & import("react").RefAttributes<HTMLDivElement>>, {}, {
        allowMotion: string;
        sm: string;
        md: string;
        lg: string;
