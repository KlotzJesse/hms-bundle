...
export declare const Select: {
    ...
    DownIcon: import("@stitches/react/types/styled-component").StyledComponent<"span", {}, {
        allowMotion: string;
        sm: string;
        md: string;
        lg: string;
    ...
    DefaultDownIcon: ({ ...props }: {
        [x: string]: any;
    }) => React.JSX.Element;
    Select: import("@stitches/react/types/styled-component").StyledComponent<"select", {}, {
        allowMotion: string;
        sm: string;
        md: string;
        lg: string;
