...
declare const SwitchRoot: import("@stitches/react/types/styled-component").StyledComponent<React.ForwardRefExoticComponent<BaseSwitch.SwitchProps & React.RefAttributes<HTMLButtonElement>>, {}, {
    allowMotion: string;
    sm: string;
    md: string;
    lg: string;
...
declare type SwitchProps = React.ComponentProps<typeof SwitchRoot>;
