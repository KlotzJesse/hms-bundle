...
declare const Root: import("@stitches/react/types/styled-component").StyledComponent<React.ForwardRefExoticComponent<BaseSlider.SliderProps & React.RefAttributes<HTMLSpanElement>>, {}, {
    allowMotion: string;
    sm: string;
    md: string;
    lg: string;
