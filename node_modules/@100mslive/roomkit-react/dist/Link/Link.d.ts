...
declare const LinkComponent: import("@stitches/react/types/styled-component").StyledComponent<"a", {
    color?: "primary" | "highEmp" | undefined;
}, {
    allowMotion: string;
    sm: string;
    md: string;
...
export declare const Link: ({ iconSide, icon, color, children, ...rest }: LinkProps) => React.JSX.Element;
export {};
